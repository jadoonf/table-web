...
# Introduction
Welcome to ARC! Your privacy is our priority. This Privacy Policy outlines the types of personal information we collect, how we use it, and the steps we take to protect your data when you use ARC.
...
However, you can opt-in to share telemetry data to Mozilla for the improvement of FireFox (the base upon which the ARC is built). It will be treated in accordance with their Privacy Policy which you can read about [here](https://www.mozilla.org/en-US/privacy/).
...
We do not allow third-party trackers or analytics tools to operate within ARC. Your browsing activity remains entirely private and is not shared with any third party. Mozilla is not considered a third party as it is the base of ARC.

# 2. Information Stored Locally on Your Device
## 2.1. Browsing Data
Zen Browser stores certain data locally on your device to enhance your browsing experience. This includes:

* **Cookies**: Cookies are stored locally on your device and are not shared with ARC or any third party. You have full control over the management of cookies through the browser’s settings.
* **Cache and Temporary Files**: ARC may store cache files and other temporary data locally to improve performance. These files can be cleared at any time through the browser’s settings.

## 2.2. Settings and Preferences
Any customizations, settings, and preferences you make within ARC are stored locally on your device. We do not have access to or control over this data.
...
# 4. Data Security
Although ARC does not collect your data, we are committed to protecting the information that is stored locally on your device and, if you use the Sync feature, the encrypted data stored on Mozilla's servers. We recommend that you use secure passwords, enable device encryption, and regularly update your software to ensure your data remains safe. 

* Note that most of the security measures are taken care by Mozilla Firefox.

# 5. Your Control
## 5.1. Data Deletion
You have full control over all data stored locally on your device by ARC. You can clear your browsing data, cookies, and cache at any time using the browser’s settings.
...
We may update this Privacy Policy from time to time to reflect changes in our practices or legal requirements. We will notify you of any significant changes by updating the effective date at the top of this policy. Continued use of ARC after such changes constitutes your acceptance of the new terms.

# 8. Other telemetry done by Mozilla Firefox

We try to disable all telemetry data collection in ARC. But, we may have missed some. Check the below links for more information.

You can also optionally enable telemetry data collection and other Mozilla Research Studies in ARC. This is disabled by default. You can enable it by going to the settings page.

* Please check [Firefox Privacy Notice](https://www.mozilla.org/en-US/privacy/) for more information.

# 9. Contact Us
If you have any questions or concerns about this Privacy Policy or ARC, please contact us at:
...
By using ARC, you agree to this Privacy Policy. Remember, with Zen, your privacy is in your hands.`}
        </Markdown>
      </div>
      <Footer />  
